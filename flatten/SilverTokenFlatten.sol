...
// File contracts/silver/SilverToken.sol
...
contract SilverToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    constructor(address trustedForwarder) ERC20("Silver Token", "SILVER") ERC20Permit("Silver Token") {
